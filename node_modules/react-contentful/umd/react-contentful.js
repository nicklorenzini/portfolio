/*! react-contentful v2.0.30 | (c) 2020 Ryan Hefner | MIT License | https://github.com/ryanhefner/react-contentful !*/
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['react-contentful'] = {}, global.React));
  ...
  var ContentfulClient = (function (clientOptions) {
    invariant_1(clientOptions.accessToken, 'ContentfulClient not created because `accessToken` was not provided.');
    invariant_1(clientOptions.space, 'ContentfulClient not created because `space` was not provided.');
    ...
    return _objectSpread(_objectSpread({
      ...
      getEntry: function () {
        var _getEntry = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(id, options) {
      ...
      getEntries: function () {
        var _getEntries = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(options) {
          var requestKey, cacheEntry, request, response;
  ...
  var ContentfulContext = /*#__PURE__*/React__default['default'].createContext(null);
  ...
  */
  ...
  var ContentfulProvider = /*#__PURE__*/function (_Component) {
    inheritsLoose(ContentfulProvider, _Component);
    ...
    _proto.render = function render() {
      ...
      warning_1(this.state.client, 'No `client` specified on <ContentfulProvider />');
  ...
  function withContentful(Component) {
    var C = function C(props) {
      var wrappedComponentRef = props.wrappedComponentRef,
          remainingProps = objectWithoutPropertiesLoose(props, ["wrappedComponentRef"]);

      return /*#__PURE__*/React__default['default'].createElement(ContentfulContext.Consumer, null, function (context) {
        return /*#__PURE__*/React__default['default'].createElement(Component, _extends_1({}, remainingProps, {
          contentful: context,
  ...
  var generateCacheKey = function generateCacheKey(props) {
    ...
    return JSON.stringify(_objectSpread$1({
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", new Promise(function (resolve, reject) {
                ...
                warning_1(contentful, 'No contentful context passed to <Query />');
                ...
                warning_1(client, 'ContentfulClient not available via context on <Query />');
                ...
                warning_1(hasQuery, 'Query props not set on <Query />');
  ...
  var _fetchData = /*#__PURE__*/function () {
    var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(props) {
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 3:
              return _context2.abrupt("return", new Promise(function (resolve, reject) {
                ...
                validateRequestRequirements(props).then(function () {
                  ...
                  var requestLocale = locale || contextLocale;
                  var request = id ? client.getEntry(id, _objectSpread$1({
                    locale: requestLocale,
                    include: include
                  }, query)) : client.getEntries(_objectSpread$1({
                    'content_type': contentType,
                    locale: requestLocale,
                    include: include
                  }, query));
  ...
  var Query = /*#__PURE__*/function (_Component) {
    inheritsLoose(Query, _Component);
    ...
    _proto.requestContentfulData = function requestContentfulData() {
      ...
      validateRequestRequirements(this.props).then(function () {
        _this3.setState({
          error: null,
          loading: true
        }, /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  onRequest(_this3.state);
                  _fetchData(_this3.props).then(function (response) {
                    _this3.setState({
  ...
  var Query$1 = withContentful(Query);
  ...
  var useContentful = function useContentful(props) {
    var contentful = React.useContext(ContentfulContext);

    var internalProps = _objectSpread$2(_objectSpread$2(_objectSpread$2({}, defaultProps), props), {}, {
    ...
    var _useState3 = React.useState(checkCache(internalProps)),
        data = _useState3[0],
        setData = _useState3[1];

    var _useState4 = React.useState(!!data),
    ...
    var requestContentfulData = function requestContentfulData() {
      ...
      _fetchData(internalProps).then(function (response) {
    ...
    if (contentful && contentful.renderPromises) {
      return contentful.renderPromises.addQueryPromise({
        fetchData: function fetchData() {
          return _fetchData(internalProps);
        },
        props: internalProps
      }, finish);
    }
  ...
  exports.withContentful = withContentful;
