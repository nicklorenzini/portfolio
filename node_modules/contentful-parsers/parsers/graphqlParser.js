...
exports.contentfulResolver = void 0;

var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));

var _fieldsParser = require("./fieldsParser");
...
function graphqlParser(rootKey, data, definitionMap, props) {
  ...
  function parseEntry(object, typename, definitionMap, depth) {
    ...
    var objectClone = Object.assign({}, object.hasOwnProperty('sys') && object.hasOwnProperty('fields') ? (0, _fieldsParser.fieldsParser)(object, props, {
      parseArrays: false,
      parseRefs: false
