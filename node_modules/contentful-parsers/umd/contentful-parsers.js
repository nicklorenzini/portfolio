...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['contentful-parsers'] = {}));
   ...
   * @return {Object}
   */
  function fieldsParser(data, props, options) {
    if (props === void 0) {
      props = {
        include: 10
      };
    ...
    function emptyModel(object) {
      return !!(object && typeof object === 'object' && object.hasOwnProperty('sys') && Object.keys(object).length === 1);
    }
    /**
  ...
  var contentfulResolver = function contentfulResolver(fieldName, rootValue) {
  ...
  function graphqlParser(rootKey, data, definitionMap, props) {
    var _ref2;
  ...
  exports.contentfulResolver = contentfulResolver;
